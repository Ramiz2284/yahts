...
$(document).ready(function () {
  ...
  $('ul.region__tabs').on('click', 'li:not(.region__tab_active)', function () {
    $(this).addClass('region__tab_active').siblings().removeClass('region__tab_active').closest('div.container').find('div.region__content').removeClass('region__content_active').eq($(this).index()).addClass('region__content_active');
  }); // Modal
